 <header>
 	<div class="container-fluid position-relative no-side-padding">
         ...
         <ul class="main-menu visible-on-click" id="main-menu">
            ...
            <li><a href="{{ route('author.dashboard') }}">Bảng điều khiển</a></li>
            @endif
            @endguest
        </ul><!-- main-menu -->
        ...
        <div class="src-area">
            <form method="GET" action="{{ route('search') }}">
             ...
             <input class="src-input" value="{{ isset($query) ? $query : '' }}" name="query" type="text" placeholder="Nhập từ khóa tìm kiếm...">
         </form>
     </div>
