                ...
                <div class="col-lg-4 col-md-12 no-left-padding">
                    ...
                    <div class="single-post info-area">
                        ...
                        <div class="sidebar-area about-area">
                            <h4 class="title"><b>Tác giả</b></h4>
                            <p>{{ $post->user->about }}</p>
                        </div>

                        <div class="tag-area">

                            <h4 class="title"><b>Chuyên mục</b></h4>
                            <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100">
                        <div class="single-post post-style-1">
                            ...
                            <a class="avatar" href="#"><img src="{{ Storage::disk('public')->url('profile/'.$randompost->user->avatar) }}" alt="Profile Image"></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="comment-form">
                        @guest
                        <p>Bạn cần đăng nhập để bình luận. <a href="{{ route('login') }}">Login</a></p>
                        @else
                        <form method="post" action="{{ route('comment.store',$post->id) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <button class="submit-btn" type="submit" id="form-submit"><b>Bình luận bài viết</b></button>
                                </div><!-- col-sm-12 -->
                    ...
                    <div class="commnets-area ">
                        ...
                        <div class="comment">
                            ...
                            <div class="post-info">
                                ...
                                <div class="left-area">
                                    <a class="avatar" href="#"><img src="{{ Storage::disk('public')->url('profile/'.$comment->user->avatar) }}" alt="Profile Image"></a>
                                </div>
